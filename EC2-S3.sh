...
BUCKET="mintic-bucket-680578888516-us-east-1"
ZIPFILE="AWS-PROJECT-TEST.zip"
DEST="/var/www/html"
...
# Si el ZIP contiene una carpeta 'bootcamp', mueve su contenido
if [ -d "$DEST/bootcamp" ]; then
    echo "Reorganizando estructura del proyecto..."
    mv $DEST/bootcamp/* $DEST/
    rm -rf $DEST/bootcamp
fi
